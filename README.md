...
- p-th root raised cosine window: `case2_rcos(x, p) = cos(0.5 * pi * x)^(2/p)`
...
- p-th root sum of raised cosine window: `case2_rcos(x, p) = ((3 - 2 cx) cx)^(1/p)`, where `cx = cos(0.5 * pi * x)^2`
