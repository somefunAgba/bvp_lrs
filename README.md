...
These windows are the smoothest over the normalized domain with respect to the first-order total variational energy functional, and provide a template for optimizer step-size control.
