...
Hat-shaped to M-shaped window profiles that can model more complex schedule logic.
...
This shape is derived by minimizing a Tikohonov regularized first-order total variational energy functional.
...
### Case 2: Maximize the total step-size magnitude while Minimizing a first-order total variational energy functional subject to boundary conditions.
