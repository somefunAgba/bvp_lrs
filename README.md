...
- p-th root linear window: `case1_lin(x, p=1) = (1 - x)^(1/p)`
- p-th root raised cosine window: `case2_rcos(x, p=1) = cos(0.5 * pi * x)^(2/p)`
...
- p-th root quadratic polynomial window: `case2_lin(x, p=1) = (1 + x - 2 x^2)^(1/p) = ((1 + 2x)(1 - x))^(1/p)`
